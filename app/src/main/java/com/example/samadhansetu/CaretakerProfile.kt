...
class CaretakerProfile : AppCompatActivity() {

    private lateinit var binding: ActivityCaretakerProfileBinding
    ...
    private fun loadAndDisplayUserProfile() {
        ...
        binding.tvProfileNameC.text = name
        binding.tvProfileHostel.text = hostel
        binding.tvProfileEmailC.text = email
        binding.tvProfilePhoneC.text = phone
